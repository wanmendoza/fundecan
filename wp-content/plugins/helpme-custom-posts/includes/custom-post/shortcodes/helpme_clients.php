...
$output .= '<div id="clients-shortcode-'.$id.'" class="helpme-clients-shortcode '.$column_css.' column-style bg-cover-'.$cover.' '.$el_class.'">';
...
$output .= '<div title="'.$company.'" class="client-logo" style="background-image:url('.helpme_thumbnail_image_gen($image_src_array[0], false, false).'); '.$dimension_style.$item_height.$bg_color.'"></div>';
...
if($hover_state == 'true' && !empty($company)) {
	...
	$output .= do_shortcode('[helpme_divider style="single" divider_color="rgba(255,255,255,0.4)" divider_width="custom_width" custom_width="35" align="center" thickness="2" margin_top="10" margin_bottom="0"]');
	$output .= '</div></div>';
}
