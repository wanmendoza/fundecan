...
$output = '<ul class="helpme-tabs-tabs">';
...
$output .= '</ul>';
$output .= '<div class="helpme-tabs-panes">';
$output .= "\n\t\t\t".wpb_js_remove_wpautop( $content );
$output .= '<div class="clearboth"></div></div>';

echo '<div id="helpme-tabs-'.$id.'" class="helpme-tabs '.$orientation.'-style '.$style.'-tabs ' . $el_class . '">' . $output . '<div class="clearboth"></div></div>';
...
if($style != 'style3') {
$helpme_styles .= '
                #helpme-tabs-'.$id.' .helpme-tabs-tabs li.ui-state-active > a, #helpme-tabs-'.$id.' .helpme-tabs-panes .inner-box{
                    background-color: '.$container_bg_color.';
                }';
}
if($style == 'style1'){
$helpme_styles .= '
                #helpme-tabs-'.$id.' .helpme-tabs-tabs li.ui-state-active a, #helpme-tabs-'.$id.' .helpme-tabs-tabs li.ui-state-active a i{
