...
$output .= '<div id="content_scroller_'.$id.'" class="helpme-content-scroller '.$bg_stretch_class.$el_class.'" style="'. $style_output.'"><div class="helpme-swiper-container helpme-swiper-slider" data-freeModeFluid="true" data-loop="false" data-slidesPerView="1" data-pagination="false" data-freeMode="false" data-direction="'.$direction.'" data-slideshowSpeed="'.$slideshow_speed.'" data-animationSpeed="'.$animation_speed.'" data-directionNav="'.$direction_nav.'">';
...
if ( $direction_nav == 'true' ) {
	$output .= '<a class="helpme-swiper-prev swiper-arrows"><i class="helpme-nuance-icon-prev-big"></i></a>';
	$output .= '<a class="helpme-swiper-next swiper-arrows"><i class="helpme-nuance-icon-next-big"></i></a>';
}
