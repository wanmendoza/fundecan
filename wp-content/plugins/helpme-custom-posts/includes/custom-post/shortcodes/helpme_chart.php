...
$output .= '<div class="helpme-chart" style="width:'.$bar_size.'px;height:'.$bar_size.'px;line-height:'.$bar_size.'px" data-percent="'.$percent.'" data-barColor="'.$bar_color.'" data-trackColor="'.$track_color.'" data-lineWidth="'.$line_width.'" data-barSize="'.$bar_size.'">';
...
$output .= '</div>';
$output .= '<div class="helpme-chart-desc" style="font-size:'.$disc_font_size.'px; '.$desc_color_style.'">'.$desc.'</div>';
$output .= '</div>';
echo '<div>'.$output.'</div>';
