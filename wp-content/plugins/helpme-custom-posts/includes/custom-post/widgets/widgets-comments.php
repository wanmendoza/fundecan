...
function Designsvilla_recent_comments() {
    unregister_widget("WP_Widget_Recent_Comments");
    register_widget("Designsvilla_WP_Widget_Recent_Comments");
}
add_action("widgets_init", "Designsvilla_recent_comments");

class Designsvilla_WP_Widget_Recent_Comments extends WP_Widget_Recent_Comments {
    ...
    function widget( $args, $instance ) {
        ...
        $output .= '<ul class="helpme-recent-comments" id="recentcomments">';
        if ( $comments ) {
