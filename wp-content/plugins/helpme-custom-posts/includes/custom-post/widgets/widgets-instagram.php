...
/*
	INSTAGRAM WIDGET
*/
class Designsvilla_Widget_Instagram_Feeds extends WP_Widget {

	function __construct() {
		$widget_ops = array( 'classname' => 'widget_instagram', 'description' => 'Displays photos from Instagram' );
		WP_Widget::__construct( 'instagram', HELPME_THEME_SLUG.' - '.'Instagram', $widget_ops );
	...
	function widget( $args, $instance ) {
		...
		if ( !empty( $instagram_id ) ) {
			...
			$output .= '<div id="instagram-feeds-'.$id.'" class="helpme-instagram-feeds" data-size="'.$size.'" data-sort="'.$sort_by.'" data-count="'.$count.'" data-userid="'.$instagram_id.'" data-accesstoken="'.$accessToken.'" data-column="'.$column.'"></div>';
