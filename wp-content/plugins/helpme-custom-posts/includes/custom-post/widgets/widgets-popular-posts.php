...
class Designsvilla_Widget_Popular_Posts extends WP_Widget {

	function __construct() {
		$widget_ops = array( "classname" => "widget_posts_lists", "description" => "Displays the Popular posts" );
		WP_Widget::__construct( "popular_posts", HELPME_THEME_SLUG . " - Popular Posts", $widget_ops );
	...
	function widget( $args, $instance ) {
        ...
        <?php	$image_src_array = wp_get_attachment_image_src( get_post_thumbnail_id(), 'full', true );	
		 ...
		 ?>
			...
			<img width="90" height="90" src="<?php echo helpme_thumbnail_image_gen($image_src, 90, 80); ?>" alt="<?php the_title(); ?>" />
	...
	function update( $new_instance, $old_instance ) {
		...
		if ( isset( $alloptions['Designsvilla_Widget_Popular_Posts'] ) )
			delete_option( 'Designsvilla_Widget_Popular_Posts' );
