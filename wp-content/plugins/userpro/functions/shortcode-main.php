<?php
	...
	function userpro( $args=array() ) {
		...
		$default_args=array(
				...
				'default_avatar_male'				=> userpro_url . 'img/default_avatar_masculino.png',
				'default_avatar_female'				=> userpro_url . 'img/default_avatar_femenino.png',
				'layout'							=> userpro_get_option('layout'),
				'margin_top'						=> 0,
				'margin_bottom'						=> '30px',
				'align'								=> 'center',
				'skin'								=> userpro_get_option('skin'),
				'required_text'						=> "Este campo es obligatorio.",
				'password_too_short'				=> "Tu contraseña es demasiado corta.",
				'passwords_do_not_match'			=> "Las contraseñas no coinciden.",
				'password_not_strong'				=> "La contraseña no es suficientemente fuerte.",
				...
				'register_side'						=> "¿Ya tienes una cuenta?",
				'register_side_action'				=> 'login',
				'register_button_action'			=> 'login',
				'register_button_primary'			=> "Registrarse",
				'register_button_secondary'			=> "Iniciar Sesion",
				'register_group'					=> 'default',
				'register_redirect'					=> '',
				'type'								=> userpro_mu_get_option('multi_forms_default'),
				'force_redirect_uri'				=> 0,
				'login_heading' 					=> "Iniciar Sesion",
				'login_side'						=> "¿Olvidaste tu contraseña?",
				'login_side_action'					=> 'reset',
				'login_button_action'				=> 'register',
				'login_button_primary'				=> "Iniciar Sesion",
				'login_button_secondary'			=> "Crear una cuenta",
				'login_group'						=> 'default',
				'login_redirect'					=> '',
				'rememberme'						=> 'true',
					
				'delete_heading'					=> "Borrar perfil",
