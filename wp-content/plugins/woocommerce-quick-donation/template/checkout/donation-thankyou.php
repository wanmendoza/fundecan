...
if ( $order ) : ?>
	...
	<?php else : ?>
		...
		<p><?php echo apply_filters( 'woocommerce_thankyou_order_received_text','Gracias. Tu donacion ha sido recibida.' , $order ); ?></p>
...
<?php else : ?>
	...
	<p><?php echo apply_filters( 'woocommerce_thankyou_order_received_text','Gracias, su orden ha sido recibida.', null ); ?></p>
