...
class WC_Quick_Donation_Listing_Table extends WP_List_Table {
	...
	protected function get_views() {
		...
		foreach ( get_post_stati(array('show_in_admin_status_list' => true), 'objects') as $status ) {
			...
			$status_links[$status_name] = "<a href='edit.php?post_type=wcqd_project&amp;page=wc_qd_orders&amp;post_status=$status_name'$class>" . sprintf( translate_nooped_plural( $status->label_count, $num_posts->$status_name ), number_format_i18n( $num_posts->$status_name ) ) . '</a>';
		}
