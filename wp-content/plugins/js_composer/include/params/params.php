...
function add_shortcode_param( $name, $form_field_callback, $script_url = null ) {
	// _deprecated_function( 'add_shortcode_param', '4.4 (will be removed in 4.11.1)', 'vc_add_shortcode_param' );
...
function do_shortcode_param_settings_field( $name, $param_settings, $param_value, $tag ) {
	// _deprecated_function( 'do_shortcode_param_settings_field', '4.4 (will be removed in 4.11.1)', 'vc_do_shortcode_param_settings_field' );
...
function vc_generate_dependencies_attributes( $settings ) {
	// _deprecated_function( 'vc_generate_dependencies_attributes', '4.8 (will be removed in 4.11.1)' );
