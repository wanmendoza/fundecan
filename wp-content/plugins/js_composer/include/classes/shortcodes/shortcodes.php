...
if ( ! class_exists( 'WPBakeryVisualComposerAbstract' ) ) {
	...
	abstract class WPBakeryVisualComposerAbstract {
		...
		public function assetURL( $asset ) {
			// _deprecated_function( 'WPBakeryShortCode::assetURL', '4.5 (will be removed in 4.11.1)', 'vc_asset_url' );
...
if ( ! class_exists( 'WPBakeryShortCode' ) ) {
	...
	abstract class WPBakeryShortCode extends WPBakeryVisualComposerAbstract {
		...
		public function endBlockComment( $string ) {
			// _deprecated_function( 'WPBakeryShortCode::endBlockComment', '4.7 (will be removed in 4.11.1)', 'vc_asset_url' );
