...
class WPBakeryShortCode_VC_Basic_Grid extends WPBakeryShortCode_Vc_Pageable {
	...
	public function getHash( $atts, $content ) {
		// _deprecated_function( 'WPBakeryShortCode_VC_Basic_Grid::getHash', '4.4.3 (will be removed in 4.11.1)', 'getId resave your grid' );
	...
	public function findPostShortcodeByHash( $page_id, $hash ) {
		// _deprecated_function( 'WPBakeryShortCode_VC_Basic_Grid::findPostShortcodeByHash', '4.4.3 (will be removed in 4.11.1)', 'findPostShortcodeById resave your grid to renew' );
