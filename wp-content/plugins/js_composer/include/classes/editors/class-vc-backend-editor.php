...
class Vc_Backend_Editor implements Vc_Editor_Interface {
	...
	public function save( $post_id ) {
		_deprecated_function( '\Vc_Backend_Editor::save', '4.4 (will be removed in 4.11.1)', '\Vc_Post_Admin::save' );
	}
	...
	public function elementBackendHtml() {
		_deprecated_function( '\Vc_Backend_Editor::elementBackendHtml', '4.9 (will be removed in 4.11.1)' );
		vc_user_access()
			->checkAdminNonce()
			->validateDie()
