...
class Vc_Settings {
	...
	public function removeAllCssClasses() {
		// _deprecated_function( '\Vc_Settings::removeAllCssClasses', '4.4 (will be removed in 4.11.1)' );
   ...
   *
	...
	public static function requireNotification() {
		// _deprecated_function( '\Vc_Settings::requireNotification', '4.4 (will be removed in 4.11.1)' );
