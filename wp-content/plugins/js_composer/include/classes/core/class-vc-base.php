...
class Vc_Base {
	...
	public function setTemplatesEditor( Vc_Templates_Editor $editor ) {
		// _deprecated_function( 'Vc_Base::setTemplatesEditor', '4.4 (will be removed in 4.11.1)', 'Vc_Base::setTemplatesPanelEditor' );
	...
	public function templatesEditor() {
		// _deprecated_function( 'Vc_Base::templatesEditor', '4.4 (will be removed in 4.11.1)', 'Vc_Base::templatesPanelEditor' );
	...
	public function enqueueStyle() {
		global $post;
          ...
          $post = get_post();
          if($post && preg_match('/vc_row/', $post->post_content) || preg_match('/helpme_page_section/', $post->post_content)) {
	...
	public function setVendorsManager( Vc_Vendors_Manager $vendor_manager ) {
		// _deprecated_function( 'Vc_Base::setVendorsManager', '4.4 (will be removed in 4.11.1)', 'autoload logic' );
	...
	public function vendorsManager() {
		// _deprecated_function( 'Vc_Base::vendorsManager', '4.4 (will be removed in 4.11.1)', 'autoload logic' );
...
class WPBakeryVisualComposer extends Vc_Base {
	...
	function __construct() {
		// _deprecated_function( 'WPBakeryVisualComposer class', '4.3 (will be removed in 4.11.1)', 'Vc_Base class' );
	}
	...
	public static function getUserTemplate( $template ) {
		// _deprecated_function( 'WPBakeryVisualComposer getUserTemplate', '4.3 (will be removed in 4.11.1)', 'Vc_Base getShortcodesTemplateDir' );
