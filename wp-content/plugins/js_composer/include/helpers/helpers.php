...
function wpb_getColumnControls( $width ) {
	// _deprecated_function( 'wpb_getColumnControls', '4.5 (will be removed in 4.11.1)' );
...
function vc_convert_shortcode( $m ) {
	...
	if ($tag == 'vc_row' || $tag == 'helpme_page_section') {
		return $output;
	}
	// Start
...
function wpb_stripslashes_if_gpc_magic_quotes( $string ) {
	// _deprecated_function( 'wpb_stripslashes_if_gpc_magic_quotes', '4.5 (will be removed in 4.11.1)', 'stripslashes' );
...
function wpb_js_composer_check_version_schedule_deactivation() {
	// _deprecated_function( 'wpb_js_composer_check_version_schedule_deactivation', '4.2 (will be removed in 4.11.1)' );
...
function vc_add_vendor( Vc_Vendor_Interface $vendor ) {
	// _deprecated_function( 'vc_add_vendor', '4.4 (will be removed in 4.11.1)', 'autoload logic' );
...
function get_row_css_class() {
	// _deprecated_function( 'get_row_css_class', '4.2 (will be removed in 4.11.1)' );
...
function vc_get_interface_version() {
	// _deprecated_function( 'vc_get_interface_version', '4.2 (will be removed in 4.11.1)' );
...
function vc_get_initerface_version() {
	// _deprecated_function( 'vc_get_initerface_version', '4.2 (will be removed in 4.11.1)' );
