...
function wpb_map( $attributes ) {
	// _deprecated_function( 'wpb_map', '4.2 (will be removed in 4.11.1)', 'vc_map' );
...
function wpb_remove( $shortcode ) {
	// _deprecated_function( 'wpb_remove', '4.2 (will be removed in 4.11.1)', 'vc_remove_element' );
...
function wpb_add_param( $shortcode, $attributes ) {
	// _deprecated_function( 'wpb_add_param', '4.2 (will be removed in 4.11.1)', 'vc_add_param' );
...
if ( ! function_exists( 'vc_set_template_dir' ) ) {
	...
	function vc_set_template_dir( $dir ) {
		// _deprecated_function( 'vc_set_template_dir', '4.2 (will be removed in 4.11.1)', 'vc_set_shortcodes_templates_dir' );
 ...
 */
function new_vc() {
	// _deprecated_function( 'new_vc', '4.7 (will be removed in 4.11.1)', 'vc_frontend_editor' );
