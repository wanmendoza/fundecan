...
function helpme_theme_blog_pagenavi( $before = '', $after = '', $blog_query, $paged ) {
    ...
    $pagenavi_options = array(
        ...
        'dotright_text' => esc_html__( '...', 'helpme' ),
        'dotleft_text' => esc_html__( '...', 'helpme' ),
        'num_pages' => 4,
        'always_show' => 0,
    ...
    if ( $max_page > 1 || intval( $pagenavi_options['always_show'] ) ) {
        ...
        echo '<div class="helpme-pagination">' . "\n";
        ob_start();
        ...
        echo '<div class="helpme-pagination-previous">';
        echo '<div>'.$previous_link.'</div>';
        echo '</div>';
        }

        if(strlen($next_link) > 1) {
            echo '<div class="helpme-pagination-next">';
