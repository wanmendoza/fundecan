	...
	jQuery(document).ready(function() {
		...
		helpme_social_network_widgets();
		helpme_color_picker();
		helpme_social_networks_custom_skin();

	});


	function helpme_social_network_widgets() {
...
/*			if (!$control.hasClass('pickerStarted')) {*/
	...
	function helpme_social_networks_custom_skin() {

			jQuery('.social-network-select-skin').live('change', function() {
				var $container = jQuery(this).parent('p').siblings('#helpme-social-custom-skin');
