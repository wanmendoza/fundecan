...
?>
	...
	<div id="bbp-author-topics-started" class="bbp-author-topics-started">
		<h2 class="entry-title"><?php esc_html_e( 'Forum Topics Created', 'helpme' ); ?></h2>
		<div class="bbp-user-section">
			...
			<?php else : ?>
				...
				<p><?php bbp_is_user_home() ? esc_html_e( 'You have not created any topics.', 'helpme' ) : esc_html_e( 'This user has not created any topics.', 'helpme' ); ?></p>
