    ...
    class ReduxFramework_bg_selector extends ReduxFramework
    {
        ...
        public function render()
        {
            ...
            if ($this->field['preset'] === true && $this->field['default']['preset'] !== false):
                $sample_patterns_path = HELPME_THEME_DIR . '/images/patterns/';
                $sample_patterns_url  = HELPME_THEME_DIR_URI . '/images/patterns/';
                ...
                if (!empty($sample_patterns)) {
                    ...
                    $placeholder = (isset($this->field['placeholder'])) ? esc_attr($this->field['placeholder']) : esc_html__('Select Preset Images', 'helpme');
                    
                    echo '<strong>' . esc_html__('Select from presets', 'helpme') . '</strong><div class="bg-selector-option"><select id="' . $this->field['id'] . '-select_image" data-placeholder="' . $placeholder . '" name="' . $this->args['opt_name'] . '[' . $this->field['id'] . '][preset]" class="redux-select-item redux-select-image-item"' . $width . ' rows="6"' . '>';
                    echo '<option></option>';
            ...
            if ($this->field['custom'] === true && $this->field['default']['custom'] !== false):
                ...
                $placeholder = isset($this->field['placeholder']) ? $this->field['placeholder'] : esc_html__('No media selected', 'helpme');
                echo '<strong style="padding-top:20px;">' . esc_html__('Upload Custom Image', 'helpme') . '</strong>';    
                ...
                echo '<span class="button media_upload_button" id="' . $this->field['id'] . '-media">' . esc_html__('Upload', 'helpme') . '</span>';
                ...
                echo '<span class="button remove-image' . $hide . '" id="reset_' . $this->field['id'] . '" rel="' . $this->field['id'] . '">' . esc_html__('Remove', 'helpme') . '</span>';
            ...
            if ($this->field['color'] === true && $this->field['default']['color'] !== false):
                echo '<strong>' . esc_html__('Background Color', 'helpme') . '</strong><div class="bg-selector-option">';
            ...
            if ($this->field['position'] === true && $this->field['default']['position'] !== false):
                ...
                echo '<strong>' . esc_html__('Background Position', 'helpme') . '</strong><div class="bg-selector-option">';
            ...
            if ($this->field['attachment'] === true && $this->field['default']['attachment'] !== false):
                ...
                echo '<strong>' . esc_html__('Background Attachment', 'helpme') . '</strong><div class="bg-selector-option">';
            ...
            if ($this->field['repeat'] === true && $this->field['default']['repeat'] !== false):
                ...
                echo '<div class="redux-container-button_set">';
                echo '<strong>' . esc_html__('Background Repeat', 'helpme') . '</strong><div class="bg-selector-option">';
                echo '<div class="buttonset ui-buttonset">';
            ...
            if ($this->field['cover'] === true && $this->field['default']['cover'] !== false):
                ...
                echo '<div class="redux-container-button_set">';
                echo '<strong>' . esc_html__('Background Cover', 'helpme') . '</strong><div class="bg-selector-option">';
                echo '<div class="buttonset ui-buttonset">';
                ...
                echo '</div>';
                echo '<div class="description field-desc">' . esc_html__('Enable this option if you want the image fit to the area no matter what size it is.', 'helpme') . '</div>';
                echo '</div></div><br><br><br>';
            endif;
            ...
            if ($this->field['border'] === true && $this->field['default']['border'] !== false):
                echo '<strong>' . esc_html__('Bottom Border Color', 'helpme') . '</strong><div class="bg-selector-option">';
