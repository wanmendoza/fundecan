...
<div id="theme-page" class="helpme-blog-single">
	...
	<div class="theme-inner-wrapper">
 		...
 		/* Meta section */ ?>
			<div class="entry-meta">
				<div class="item-holder">
					...
					<div class="causes-categories"><?php echo the_category( 'causes_category','causes' ); ?></div>
		...
		echo '<span class="cause-campaign">'. do_shortcode('[totaldonations-progress-bar campaign="'.$campaign.'" button="yes" button_text="DONATE NOW"]') .'</span>';
        }
		?>
			<?php echo '<span class="cause-desc">' . $content . '</span>' ?>
