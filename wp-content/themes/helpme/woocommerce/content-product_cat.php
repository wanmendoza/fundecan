...
global $woocommerce_loop, $woocommerce, $helpme_settings;
	...
	<a href="<?php echo get_term_link( $category->slug, 'product_cat' ); ?>">
		...
		<?php
	        ...
	        if ( $thumbnail_id ) {
	            ...
	            $image = bfi_thumb(HELPME_THEME_IMAGES . '/dark-empty-thumb.png', array('width' => $width*2, 'height' => $height*2, 'crop' => false));
		...
		<h4><span>
			<?php
				...
				if ( $category->count > 0 )
					echo apply_filters( 'woocommerce_subcategory_count_html', ' <span class="count">' . $category->count . ' '.esc_html__('Items', 'helpme').'</span>', $category );
			?>
		</span>
		</h4>
